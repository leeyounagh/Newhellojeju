...
export function removeFromgood(contentsId) {
  const request = axios
    .get(`/api/users/removeFromGood?id=${contentsId}`)
    .then((response) => {
...
export function addschedule(body) {
  const request = axios
    .post(`/api/users/addschedule`, body)
    .then((response) => {
...
export function addcommunity(body) {
  const request = axios
    .post(`/api/users/addcommunity`, body)
    .then((response) => {
      if (response.data.success === true) {
...
export function removeforschedule(contentsId) {
  const request = axios
    .get(`/api/users/removefromschedule?id=${contentsId}`)
    .then((response) => {
